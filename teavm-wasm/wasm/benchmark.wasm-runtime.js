...
import fileName from 'url:./benchmark.wasm'
...
TeaVM.wasm = function () {
    ...
    function load(path, options) {
        ...
        // console.log("inside load, path:", fileName, window.location);

        return WebAssembly.instantiateStreaming(fetch(fileName), importObj).then((obj => {
